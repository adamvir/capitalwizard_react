 ...
 * 
 * MEGJEGYZÉS:
 * - Game logic: Same as web version
 * - Matching pairs: Maximum 5 visible at once
 * - Timer: Countdown from config.matchingTimeLimit
  ...
  useEffect(() => {
    if (gameStatus === 'won' || gameStatus === 'lost') {
      ...
      emojiTranslateY.value = withRepeat(
        withSequence(
          withTiming(offset, { duration: 500, easing: Easing.inOut(Easing.ease) }),
